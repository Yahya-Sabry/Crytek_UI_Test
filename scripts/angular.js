!function (t, e, n) {
    ...
    function o(t, e, n) {
        var r, a;
        if (t)if (C(t))for (r in t)"prototype" == r || "length" == r || "name" == r || t.hasOwnProperty && !t.hasOwnProperty(r) || e.call(n, t[r], r, t); else if (hi(t) || i(t)) {
    ...
    function q(t, e, n, r) {
        ...
        } else if (e = t, t)if (hi(t))e = q(t, [], n, r); else if (x(t))e = new Date(t.getTime()); else if (S(t))e = new RegExp(t.source, t.toString().match(/[^\/]*$/)[0]), e.lastIndex = t.lastIndex; else if (y(t)) {
    ...
    function Z(t, e) {
        var n, r, i = vi.length;
        for (t = ei(t), r = 0; i > r; ++r)if (n = vi[r] + e, w(n = t.attr(n)))return n;
        return null
    }
    ...
    function re() {
        ...
        gi || (ni = t.jQuery, ni && ni.fn.on ? (ei = ni, f(ni.fn, {
            ...
            var n;
            if (fi)fi = !1; else for (var r, i = 0; null != (r = t[i]); i++)n = ni._data(r, "events"), n && n.$destroy && ni(r).triggerHandler("$destroy");
            e(t)
    ...
    function de(e) {
        ...
        ri("ng", ["ngLocale"], ["$provide", function (t) {
            t.provider({$$sanitizeUri: Jn}), t.provider("$compile", Ze).directive({
                a: Mo,
                input: Yo,
                textarea: Yo,
                form: qo,
                ...
                ngValue: Ko,
                ngModelOptions: Sa
            }).directive({ngInclude: la}).directive(jo).directive(aa), t.provider({
                $anchorScroll: ze,
                $animate: Yi,
                $browser: Ye,
                $cacheFactory: Je,
    ...
    function xe(t, e) {
        if (e || Se(t), t.querySelectorAll)for (var n = t.querySelectorAll("*"), r = 0, i = n.length; i > r; r++)Se(n[r])
    }
    ...
    function Ce(t, e, n, r) {
        ...
        if (s)if (e)o(e.split(" "), function (e) {
            ...
            Ti(t, e, s), delete a[e]
        }); else for (e in a)"$destroy" !== e && Ti(t, e, s), delete a[e]
    }
    ...
    function Ee(t, e) {
        var r = t.ng339, i = r && Ei[r];
        return e && !i && (t.ng339 = r = pe(), i = Ei[r] = {events: {}, data: {}, handle: n}), i
    }

    function ke(t, e, n) {
        if (me(t)) {
            var r = g(n), i = !r && e && !y(e), o = !e, a = Ee(t, !i), s = a && a.data;
            if (r)s[e] = n; else {
                if (o)return s;
                if (i)return s && s[e];
                f(s, e)
    ...
    function je(t, e, r) {
        ...
        for (var i = hi(e) ? e : [e]; t;) {
            for (var o = 0, a = i.length; a > o; o++)if ((r = ei.data(t, i[o])) !== n)return r;
    ...
    function _e(t) {
        var e = t.toString().replace(zi, ""), n = e.match(_i);
    ...
    function Le(t, e) {
        ...
        function $(t, n) {
            ...
            function i(t, n, i, o) {
                ...
                var a, s, u, c = [], l = Le.$$annotate(t, e, o);
            ...
            function o(t, e, n) {
                var r = Object.create((hi(t) ? t[t.length - 1] : t).prototype || null), o = i(t, r, e, n);
                return y(o) || C(o) ? o : r
            }

            return {
                invoke: i, instantiate: o, get: r, annotate: Le.$$annotate, has: function (e) {
        ...
        e = e === !0;
        var g = {}, b = "Provider", x = [], S = new He([], !0), E = {
            $provide: {
                provider: r(i),
                factory: r(s),
                service: r(c),
    ...
    function We(t, e, r, i) {
        ...
        var $ = this, v = e[0], g = t.location, y = t.history, b = t.setTimeout, x = t.clearTimeout, C = {};
        $.isMock = !1;
        var S = 0, E = [];
        ...
        var T, O, D = g.href, M = e.find("base"), j = null;
        ...
        $.cookies = function (t, e) {
            var i, o, a, s, u;
            if (!t) {
                if (v.cookie !== R)for (R = v.cookie, o = R.split("; "), q = {}, s = 0; s < o.length; s++)a = o[s], u = a.indexOf("="), u > 0 && (t = d(a.substring(0, u)), q[t] === n && (q[t] = d(a.substring(u + 1))));
                return q
            }
    ...
    function Je() {
        this.$get = function () {
            function t(t, n) {
                ...
                var a = 0, s = f({}, n, {id: t}), u = {}, c = n && n.capacity || Number.MAX_VALUE, l = {}, h = null, d = null;
                return e[t] = {
                    put: function (t, e) {
    ...
    function Ze(t, r) {
        ...
        var a = {}, s = "Directive", c = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, l = /(([\w\-]+)(?:\:([^;]+))?;?)/, h = P("ngSrc,ngSrcset,src,srcset"), m = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, b = /^(on[a-z]+|formaction)$/;
        ...
        this.debugInfoEnabled = function (t) {
            ...
            function M(t, e, n, r, i) {
                ...
                return function (e, n, r) {
                    ...
                    var c;
                    if (c = "html" !== s ? ei(X(s, ei("<div>").append(t).html())) : n ? Ii.clone.call(t) : t, o)for (var l in o)c.data("$" + l + "Controller", o[l].instance);
            ...
            function R(t, e, n, r, i) {
                ...
                switch (s) {
                    case yi:
                        ...
                        if (a = t.className, y(a) && (a = a.animVal), w(a) && "" !== a)for (; o = l.exec(a);)d = Xe(o[2]), L(e, d, "C", r, i) && (n[d] = di(o[3])), a = a.substr(o.index + o[0].length);
                        break;
                    case wi:
                        Z(e, t.nodeValue);
                        break;
            ...
            function _(t, a, s, u, c, l, f, h, d) {
                function p(t, e, n, r) {
                    t && (n && (t = H(t, n, r)), t.require = E.require, t.directiveName = A, (N === E || E.$$isolateScope) && (t = re(t, {isolateScope: !0})), f.push(t)), e && (n && (e = H(e, n, r)), e.require = E.require, e.directiveName = A, (N === E || E.$$isolateScope) && (e = re(e, {isolateScope: !0})), h.push(e))
                }
                ...
                for (var x, S, E, A, T, O, D, j = -Number.MAX_VALUE, P = d.controllerDirectives, N = d.newIsolateScopeDirective, V = d.templateDirective, q = d.nonTlbTranscludeDirective, _ = !1, L = !1, G = d.hasElementTranscludeDirective, J = s.$$element = ei(a), Z = l, Q = u, te = 0, ne = t.length; ne > te; te++) {
                    ...
                    if ((D = E.scope) && (E.templateUrl || (y(D) ? (K("new/isolated scope", N || x, E, J), N = E) : K("new/isolated scope", N, E, J)), x = x || E), A = E.name, !E.templateUrl && E.controller && (D = E.controller, P = P || {}, K("'" + A + "' controller", P[A], E, J), P[A] = E), (D = E.transclude) && (_ = !0, E.$$tlb || (K("transclusion", q, E, J), q = E), "element" == D ? (G = !0, j = E.priority, T = J, J = s.$$element = ei(e.createComment(" " + A + ": " + s[A] + " ")), a = J[0], ee(c, F(T), a), Q = M(T, u, j, Z && Z.name, {nonTlbTranscludeDirective: q})) : (T = ei(be(a)).contents(), J.empty(), Q = M(T, u))), E.template)if (L = !0, K("template", V, E, J), V = E, D = C(E.template) ? E.template(J, s) : E.template, D = le(D), E.replace) {
                        ...
                        ee(c, J, a);
                        var ue = {$attr: {}}, ce = R(a, [], ue), fe = t.splice(te + 1, t.length - (te + 1));
                    ...
                    }), ne = t.length; else if (E.compile)try {
            ...
            function Y(t, e, n, r, i, a, s, c) {
                var l, f, h = [], p = e[0], $ = t.shift(), v = d($, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: $
                }), m = C($.templateUrl) ? $.templateUrl(e, n) : $.templateUrl, g = $.templateNamespace;
                return e.empty(), u(A.getTrustedResourceUrl(m)).then(function (u) {
                    ...
                    for (t.unshift(v), l = _(t, d, n, i, e, $, a, s, c), o(r, function (t, n) {
                        ...
                        var S = h.shift(), E = h.shift(), k = h.shift(), A = h.shift(), T = e[0];
                        if (!S.$$destroyed) {
                            if (E !== p) {
                                var O = E.className;
            ...
            ae.prototype = {
                $normalize: Xe, $addClass: function (t) {
                    ...
                    var s, u = this.$$element[0], c = qe(u, t), l = Re(u, t), f = t;
                    if (c ? (this.$$element.prop(t, e), a = c) : l && (this[l] = e, f = l), this[t] = e, a ? this.$attr[t] = a : (a = this.$attr[t], a || (this.$attr[t] = a = ne(t, "-"))), s = N(this.$$element), "a" === s && "href" === t || "img" === s && "src" === t)this[t] = e = O(e, "src" === t); else if ("img" === s && "srcset" === t) {
            ...
            var se = r.startSymbol(), ue = r.endSymbol(), le = "{{" == se || "}}" == ue ? $ : function (t) {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, u, c, l, h, d) {
            function p(e) {
                ...
                function s(e) {
                    ...
                    t:for (n in o) {
                        r = Jr(n);
                        for (i in s)if (Jr(i) === r)continue t;
                        s[n] = o[n]
                    }
                    return a(s)
                }
            ...
            function b(r, i) {
                ...
                var d, $, v = h.defer(), w = v.promise, b = r.headers, x = S(r.url, r.params);
    ...
    function pn(t, e, r, i, a) {
        ...
        return function (a, u, c, l, f, h, d, $) {
            ...
            if (h > 0)var S = r(v, h); else M(h) && h.then(v)
        }
    }
    ...
    function vn() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", function (t, e, n, r) {
            function i(i, a, s, u) {
                var c = e.setInterval, l = e.clearInterval, f = 0, h = g(u) && !u, d = (h ? r : n).defer(), p = d.promise;
    ...
    function kn(t, e) {
        ...
        yn(t, this), this.$$parse = function (t) {
            ...
            var t = Y(this.$$search), e = this.$$hash ? "#" + J(this.$$hash) : "";
    ...
    function An(t, e) {
        ...
        yn(t, this), this.$$parse = function (r) {
            ...
            var n = Y(this.$$search), r = this.$$hash ? "#" + J(this.$$hash) : "";
        ...
        this.hashPrefix = function (e) {
            ...
            o.on("click", function (t) {
                if (e.rewriteLinks && !t.ctrlKey && !t.metaKey && !t.shiftKey && 2 != t.which && 2 != t.button) {
                    for (var i = ei(t.target); "a" !== N(i[0]);)if (i[0] === o[0] || !(i = i.parent())[0])return;
    ...
    function Un(t, e, r, i, o, a, s) {
        ...
        var u = function (t) {
            return Nn(t, a)
        }, c = s || In(t) ? u : $, l = s || In(e) ? u : $, f = s || In(r) ? u : $, h = s || In(i) ? u : $, d = s || In(o) ? u : $;
        return function (a, s) {
    ...
    function Hn(t, e, r) {
        var i = e.expensiveChecks, a = i ? yo : go, s = a[t];
        if (s)return s;
    ...
    function Bn() {
        ...
        this.$get = ["$filter", "$sniffer", function (n, r) {
            ...
            var d = {csp: r.csp, expensiveChecks: !1}, $ = {csp: r.csp, expensiveChecks: !0};
            return function (r, o, a) {
                var s, v, m;
                switch (typeof r) {
                    case"string":
                        ...
                        if (s = g[m], !s) {
                            ...
                            var y = a ? $ : d, w = new vo(y), b = new mo(w, n, y);
        ...
        this.digestTtl = function (t) {
            ...
            d.prototype = {
                constructor: d, $new: function (e, n) {
                    ...
                    return a = null, C(e) || (s.fn = p), o || (o = i.$$watchers = []), o.unshift(s), function () {
                        V(o, s), a = null
                    }
                    ...
                    n.$stateful = !0;
                    var o, a, s, u = this, c = e.length > 1, f = 0, h = l(t, n), d = [], p = {}, $ = !0, v = 0;
                    return this.$watch(h, r)
                }, $digest: function () {
                    var t, r, i, o, c, l, h, d, p, m, g = e, y = this, x = [];
                    ...
                    S.$$phase || E.length || f.defer(function () {
                        E.length && S.$digest()
                    }), E.push({scope: this, expression: t, locals: e})
            ...
            var S = new d, E = S.$$asyncQueue = [], k = S.$$postDigestQueue = [], A = S.$$applyAsyncQueue = [];
            return S
        }]
    }
    ...
    function tr() {
        this.$get = ["$window", "$document", function (t, e) {
            var n, r, i = {}, o = h((/android (\d+)/.exec(Jr((t.navigator || {}).userAgent)) || [])[1]), a = /Boxee/i.test((t.navigator || {}).userAgent), s = e[0] || {}, u = /^(Moz|webkit|ms)(?=[A-Z])/, c = s.body && s.body.style, l = !1, f = !1;
            if (c) {
    ...
    function dr(t, e, n, r, i) {
        ...
        if (c)i > 0 && 1 > t && (s = t.toFixed(i), t = parseFloat(s)); else {
            ...
            var h = ("" + t).split(Eo), d = h[0];
            h = h[1] || "";
            var p, $ = 0, v = e.lgSize, g = e.gSize;
            if (d.length >= v + g)for ($ = d.length - v, p = 0; $ > p; p++)($ - p) % g === 0 && 0 !== p && (s += n), s += d.charAt(p);
    ...
    function vr(t, e) {
        return function (n, r) {
            var i = n["get" + t](), o = Zr(e ? "SHORT" + t : t);
            return r[o][i]
        }
    }
    ...
    function zr(t) {
        ...
        var s = t.ctrl, u = t.$element, c = {}, l = t.set, f = t.unset, h = t.parentForm, d = t.$animate;
    ...
    var Wr = /^\/(.+)\/([a-z]*)$/, Yr = "validity", Jr = function (t) {
        return w(t) ? t.toLowerCase() : t
    }, Kr = Object.prototype.hasOwnProperty, Zr = function (t) {
    ...
    var ti, ei, ni, ri, ii = [].slice, oi = [].splice, ai = [].push, si = Object.prototype.toString, ui = r("ng"), ci = t.angular || (t.angular = {}), li = 0;
    ti = e.documentMode, p.$inject = [], $.$inject = [];
    var fi, hi = Array.isArray, di = function (t) {
        return w(t) ? t.trim() : t
    }, pi = function (t) {
    ...
    }, vi = ["ng-", "data-ng-", "ng:", "x-ng-"], mi = /[A-Z]/g, gi = !1, yi = 1, wi = 3, bi = 8, xi = 9, Ci = 11, Si = {
        full: "1.3.15",
        major: 1,
        minor: 3,
        dot: 15,
    ...
    we.expando = "ng339";
    var Ei = we.cache = {}, ki = 1, Ai = function (t, e, n) {
    ...
    var Oi = /([\:\-\_]+(.))/g, Di = /^moz([A-Z])/, Mi = {
        mouseleave: "mouseout",
        mouseenter: "mouseover"
    }, ji = r("jqLite"), Pi = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Ni = /<|&#?\w+;/, Vi = /<([\w:]+)/, qi = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ri = {
    ...
    var Hi = {ngMinlength: "minlength", ngMaxlength: "maxlength", ngMin: "min", ngMax: "max", ngPattern: "pattern"};
    o({data: ke, removeData: Se}, function (t, e) {
        we[e] = t
    }), o({
        data: ke, inheritedData: je, scope: function (t) {
        ...
        removeData: Se, on: function Wa(t, e, n, r) {
        ...
        }, addClass: Oe, removeClass: Te, toggleClass: function (t, e, n) {
            ...
            var r, i, a, s = e.type || e, u = Ee(t), c = u && u.events, l = c && c[s];
            l && (r = {
                preventDefault: function () {
    ...
    var _i = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Bi = /,/, Li = /^\s*(_?)(\S+?)\1\s*$/, zi = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Gi = r("$injector");
    Le.$$annotate = Be;
    var Wi = r("$animate"), Yi = ["$provide", function (t) {
    ...
    var Ki = /^((?:x|data)[\:\-_])/i, Zi = r("$controller"), Xi = "application/json", Qi = {"Content-Type": Xi + ";charset=utf-8"}, to = /^\[|^\{(?!\{)/, eo = {
        "[": /]$/,
        "{": /}$/
        ...
        $$html5: !1, $$replace: !1, absUrl: On("$$absUrl"), url: function (t) {
            if (m(t))return this.$$url;
            var e = io.exec(t);
            return (e[1] || "" === t) && this.path(decodeURIComponent(e[1])), (e[2] || e[1] || "" === t) && this.search(e[3] || ""), this.hash(e[5] || ""), this
        }, protocol: On("$$protocol"), host: On("$$host"), port: On("$$port"), path: Dn("$$path", function (t) {
    ...
    var uo = r("$parse"), co = Function.prototype.call, lo = Function.prototype.apply, fo = Function.prototype.bind, ho = ce();
    o({
        "null": function () {
            return null
        }, "true": function () {
    ...
    }), $o = {n: "\n", f: "\f", r: "\r", t: "	", v: "", "'": "'", '"': '"'}, vo = function (t) {
        this.options = t
    };
    vo.prototype = {
        constructor: vo, lex: function (t) {
            for (this.text = t, this.index = 0, this.tokens = []; this.index < this.text.length;) {
                ...
                if ('"' === e || "'" === e)this.readString(e); else if (this.isNumber(e) || "." === e && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(e))this.readIdent(); else if (this.is(e, "(){}[].,;:?"))this.tokens.push({
                    ...
                    var n = e + this.peek(), r = n + this.peek(2), i = po[e], o = po[n], a = po[r];
                    if (i || o || a) {
                        var s = a ? r : o ? n : e;
    ...
    mo.ZERO = f(function () {
        return 0
    }, {sharedGetter: !0, constant: !0}), mo.prototype = {
        constructor: mo, parse: function (t) {
            ...
            return function (a, s) {
                ...
                if (o)for (var l = r.length; l--;)o[l] = Nn(r[l](a, s), i);
                Nn(u, i), Vn(c, i);
    ...
    var go = ce(), yo = ce(), wo = Object.prototype.valueOf, bo = r("$sce"), xo = {
        HTML: "html",
        CSS: "css",
        URL: "url",
        RESOURCE_URL: "resourceUrl",
        JS: "js"
    }, Ji = r("$compile"), Co = e.createElement("a"), So = ir(t.location.href);
    ...
    var Eo = ".", ko = {
        ...
        GGG: xr,
        GGGG: Cr
    }, Ao = /((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/, To = /^\-?\d+$/;
    Sr.$inject = ["$locale"];
    var Oo = v(Jr), Do = v(Zr);
    Ar.$inject = ["$parse"];
    var Mo = v({
    ...
    var Vo = function (t) {
        return ["$timeout", function (e) {
            var r = {
                name: "form", restrict: t ? "EAC" : "E", controller: Dr, compile: function (r, i) {
    ...
    }, qo = Vo(), Ro = Vo(!0), Io = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Uo = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Fo = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Ho = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, _o = /^(\d{4})-(\d{2})-(\d{2})$/, Bo = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Lo = /^(\d{4})-W(\d\d)$/, zo = /^(\d{4})-(\d\d)$/, Go = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Wo = {
        text: jr,
    ...
    }), ea = Lr("", !0), na = Lr("Odd", 0), ra = Lr("Even", 1), ia = Tr({
    ...
    var ua = ["$animate", function (t) {
        ...
        return {
            restrict: "A", priority: 100, require: "ngModel", link: function (t, e, r, i) {
                var a = e.attr(r.$attr.ngList) || ", ", s = "false" !== r.ngTrim, u = s ? di(a) : a, c = function (t) {
                    if (!m(t)) {
                        var e = [];
    ...
    }, da = "ng-valid", pa = "ng-invalid", $a = "ng-pristine", va = "ng-dirty", ma = "ng-untouched", ga = "ng-touched", ya = "ng-pending", wa = new r("ngModel"), ba = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (t, e, r, i, a, s, u, c, l, f) {
        this.$viewValue = Number.NaN, this.$modelValue = Number.NaN, this.$$rawModelValue = n, this.$validators = {}, this.$asyncValidators = {}, this.$parsers = [], this.$formatters = [], this.$viewChangeListeners = [], this.$untouched = !0, this.$touched = !1, this.$pristine = !0, this.$dirty = !1, this.$valid = !0, this.$invalid = !1, this.$error = {}, this.$$success = {}, this.$pending = n, this.$name = f(r.name || "", !1)(t);
        var h, d = a(r.ngModel), $ = d.assign, v = d, y = $, w = null, x = this;
        this.$$setOptions = function (t) {
            if (x.$options = t, t && t.getterSetter) {
                ...
                v = function (t) {
                    ...
                    C(d(t)) ? n(t, {$$$p: x.$modelValue}) : $(t, x.$modelValue)
                }
        ...
        var S = i.inheritedData("$formController") || Po, E = 0;
        zr({
            ctrl: this, $element: i, set: function (t, e) {
                t[e] = !0
            }, unset: function (t, e) {
                delete t[e]
            }, parentForm: S, $animate: s
    ...
    }, Ea = Tr({terminal: !0, priority: 1e3}), ka = ["$locale", "$interpolate", function (t, e) {
        ...
        return {
            restrict: "EA", link: function (i, a, s) {
                ...
                var c, l = s.count, f = s.$attr.when && a.attr(s.$attr.when), h = s.offset || 0, d = i.$eval(f) || {}, p = {}, $ = e.startSymbol(), v = e.endSymbol(), m = $ + l + "-" + h + v, g = ci.noop;
                o(s, function (t, e) {
                    var n = r.exec(e);
                    if (n) {
                        var i = (n[1] ? "-" : "") + Jr(n[2]);
            ...
            compile: function (r, h) {
                ...
                return y ? x = t(y) : (S = function (t, e) {
                    ...
                    t.$watchCollection(m, function (r) {
                        var h, m, y, x, k, A, T, O, D, M, j, P, N = e[0], V = ce();
                        if (g && (t[g] = r), i(r))D = r, O = C || S; else {
                            O = C || E, D = [];
                            for (var q in r)r.hasOwnProperty(q) && "$" != q.charAt(0) && D.push(q);
                            D.sort()
                        }
                        for (x = D.length, j = new Array(x), h = 0; x > h; h++)if (k = r === D ? h : D[h], A = r[k], T = O(k, A, h), v[T])M = v[T], delete v[T], V[T] = M, j[h] = M; else {
                            ...
                            j[h] = {id: T, scope: n, clone: n}, V[T] = !0
                        }
                        for (var R in v) {
                            if (M = v[R], P = ue(M.clone), a.leave(P), P[0].parentNode)for (h = 0, m = P.length; m > h; h++)P[h][s] = !0;
                            M.scope.$destroy()
                        }
    ...
    }], Ta = "ng-hide", Oa = "ng-hide-animate", Da = ["$animate", function (t) {
        return {
            restrict: "A", multiElement: !0, link: function (e, n, r) {
                e.$watch(r.ngShow, function (e) {
                    t[e ? "removeClass" : "addClass"](n, Ta, {tempClasses: Oa})
                })
            }
        }
        ...
        return {
            restrict: "A", multiElement: !0, link: function (e, n, r) {
                e.$watch(r.ngHide, function (e) {
                    t[e ? "addClass" : "removeClass"](n, Ta, {tempClasses: Oa})
                })
            }
        }
    ...
    }], Ia = r("ngOptions"), Ua = v({restrict: "A", terminal: !0}), Fa = ["$compile", "$parse", function (t, r) {
            ...
            link: function (s, u, c, l) {
                ...
                function d(e, s, u) {
                    ...
                    function d(t) {
                        ...
                        } else e = new He(t); else V && (t = c(V, null, t));
                        return function (n, r) {
                            var i;
                    ...
                    function m() {
                        x = !1;
                        var t, n, r, i, l, f, h, p, m, w, E, A, T, O, j, N, U, F = {"": []}, H = [""], _ = u.$viewValue, B = P(e) || [], L = D ? a(B) : B, z = {}, G = d(_), W = !1;
                        ...
                        for (y || (b || null === _ ? F[""].unshift({
                            ...
                            label: "",
                            selected: !W
                        }) : W || F[""].unshift({id: "?", label: "", selected: !0})), E = 0, m = H.length; m > E; E++) {
                    ...
                    var k = r(E[2] || E[1]), A = E[4] || E[6], T = / as /.test(E[0]) && E[1], O = T ? r(T) : null, D = E[5], M = r(E[3] || ""), j = r(E[2] ? E[1] : A), P = r(E[7]), N = E[8], V = N ? r(E[8]) : null, q = {}, R = [[{
                        element: s,
                        label: ""
                    }]], I = {};
                ...
                if (l[1]) {
                    for (var p, $ = l[0], v = l[1], y = c.multiple, w = c.ngOptions, b = !1, x = !1, C = ei(e.createElement("option")), S = ei(e.createElement("optgroup")), E = C.clone(), k = 0, A = u.children(), T = A.length; T > k; k++)if ("" === A[k].value) {
                        p = b = A.eq(k);
                        break
                    }
    ...
    }], _a = v({restrict: "E", terminal: !1}), Ba = function () {
        return {
            restrict: "A", require: "?ngModel", link: function (t, e, n, r) {
...
}(window, document), !window.angular.$$csp() && window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>'), function (t, e, n) {
    "use strict";
    function r(t) {
        var e;
        if (e = t.match(c)) {
            var n = new Date(0), r = 0, o = 0;
    ...
    function a(t, r, i, o) {
        ...
        function c(t, a, s, c, l, v, m) {
            ...
            for (var C, S = -1; C = f[++S];)if (C.match(t, a, s, l || {})) {
                if (C.response)(o ? o.defer : p)(y(C)); else {
        ...
        var f = [], h = [], d = [], p = e.bind(d, d.push), $ = e.copy;
        return c.when = function (t, e, r, i) {
            var u = new s(t, e, r, i), c = {
    ...
    e.mock = {}, e.mock.$BrowserProvider = function () {
        ...
        this.isMock = !0, t.$$url = "http://server/", t.$$lastUrl = t.$$url, t.pollFns = [], t.$$completeOutstandingRequest = e.noop, t.$$incOutstandingRequestCount = e.noop, t.onUrlChange = function (e) {
            ...
            if (e.isDefined(n))t.defer.now += n; else {
        ...
        this.$get = ["$browser", "$rootScope", "$q", "$$q", function (t, r, i, o) {
            var a = [], s = 0, u = 0, c = function (c, l, f, h) {
                function d() {
                ...
                var p = 0, $ = e.isDefined(h) && !h, v = ($ ? o : i).defer(), m = v.promise;
    ...
    if (e.mock.TzDate = function (t, n) {
            ...
            t.value("$$animateReflow", function (t) {
                ...
                var o = {
                    queue: [], cancel: t.cancel, enabled: t.enabled, triggerCallbackEvents: function () {
                        r.flush()
            ...
            function e() {
                for (var t, e = 0, n = [this.$$childHead]; n.length;)for (t = n.shift(); t;)e += 1, n.push(t.$$childHead), t = t.$$nextSibling;
                return e
            }

            function n() {
                for (var t, e = this.$$watchers ? this.$$watchers.length : 0, n = [this.$$childHead]; n.length;)for (t = n.shift(); t;)e += t.$$watchers ? t.$$watchers.length : 0, n.push(t.$$childHead), t = t.$$nextSibling;
                return e
            }
        ...
        d.prototype.toString = Error.prototype.toString, t.inject = e.mock.inject = function () {
            function t() {
                var t = l.$modules || [], i = !!l.$injectorStrict;
            ...
            var n = Array.prototype.slice.call(arguments, 0), r = new Error("Declaration Location");
            return h() ? t.call(l) : t
    ...
    e.module("ngAnimate", ["ng"]).directive("ngAnimateChildren", function () {
        ...
        var c, l = e.noop, f = e.forEach, h = i.$$selectors, d = e.isArray, p = e.isString, $ = e.isObject, v = 1, m = "$$ngAnimateState", g = "$$ngAnimateChildren", y = "ng-animate", w = {running: !0};
        r.decorator("$animate", ["$delegate", "$$q", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", "$templateRequest", "$$jqLite", function (t, n, r, v, b, x, C, S, E, k) {
            ...
            function j(t, n, r, i) {
                function o(t, e) {
                    ...
                    return n || r ? ("leave" == e && (r = n, n = null), x.push({event: e, fn: n}), y.push({
                        event: e,
                        fn: r
                    }), !0) : void 0
                }
                ...
                if (s) {
                    ...
                    var h = "setClass" == n, p = h || "addClass" == n || "removeClass" == n || "animate" == n, $ = t.attr("class"), v = $ + " " + r;
                    if (F(v)) {
                        var m = l, g = [], y = [], w = l, b = [], x = [], C = (" " + v).replace(/\s+/g, ".");
            ...
            function P(t, n, r, i, o, a, s, u) {
                ...
                var S = r.data(m) || {}, E = S.active || {}, k = S.totalActive || 0, A = S.last, T = !1;
                if (k > 0) {
                    var O = [];
                    if (b.isClassBased) {
                        if ("setClass" == A.event)O.push(A), V(r, n); else if (E[n]) {
                            var D = E[n];
                            D.event == t ? T = !0 : (O.push(D), V(r, n))
                        }
                    } else if ("leave" == t && E["ng-leave"])T = !0; else {
                ...
                E = S.active || {}, k = S.totalActive || 0, "leave" == t && r.one("$destroy", function () {
                    var t = e.element(this), n = t.data(m);
                    if (n) {
            ...
            }), I = 0, U = i.classNameFilter(), F = U ? function (t) {
                return U.test(t)
            } : function () {
                return !0
            };
            return {
                animate: function (t, e, n, r, i) {
                    ...
                    return l || (l = {}, l.classes = {}), c = l.classes, r = d(r) ? r : r.split(" "), f(r, function (t) {
                        ...
                        var s = n.data(u);
                        n.removeData(u);
                        var c = n.data(m) || {}, l = D(n, s, c.active);
            ...
            function g(t, e) {
                ...
                if (!n) {
                    ...
                    f(t, function (t) {
                        if (t.nodeType == v) {
                            var e = r.getComputedStyle(t) || {}, n = e[D + q];
                            i = Math.max(y(n), i);
                            var u = e[D + I];
                            o = Math.max(y(u), o);
                            {
            ...
            function w(t) {
                var e = t.parent(), n = e.data(H);
                return n || (e.data(H, ++W), n = W), n + "-" + o(t).getAttribute("class")
            }

            function b(t, e, n, r) {
                var i = ["ng-enter", "ng-leave", "ng-move"].indexOf(n) >= 0, a = w(e), s = a + " " + n, u = G[s] ? ++G[s].total : 0, l = {};
                if (u > 0) {
                    var f = n + "-stagger", h = a + " " + f, d = !G[h];
                    d && c.addClass(e, f), l = g(e, h), d && c.removeClass(e, f)
                }
                c.addClass(e, n);
                var p = e.data(_) || {}, $ = g(e, s), v = $.transitionDuration, m = $.animationDuration;
                if (i && 0 === v && 0 === m)return c.removeClass(e, n), !1;
                var y = r || i && v > 0, b = m > 0 && l.animationDelay > 0 && 0 === l.animationDuration, x = p.closeAnimationFns || [];
                e.data(_, {
                    stagger: l,
                    cacheKey: s,
                    running: p.running || 0,
            ...
            function x(t, e, n, r, i) {
                ...
                function u(t) {
                    t.stopPropagation();
                    var e = t.originalEvent || t, n = e.$manualTimeStamp || e.timeStamp || Date.now(), i = parseFloat(e.elapsedTime.toFixed(B));
                    Math.max(n - R, 0) >= j && i >= O && r()
                }

                var l = o(e), h = e.data(_);
                ...
                var v = "", m = [], y = h.itemIndex, w = h.stagger, b = 0;
                if (y > 0) {
                    var x = 0;
                ...
                var k = h.cacheKey + " " + d, A = g(e, k), O = Math.max(A.transitionDuration, A.animationDuration);
                ...
                var D = Math.max(A.transitionDelay, A.animationDelay), j = D * z;
                if (m.length > 0) {
                    var V = l.getAttribute("style") || "";
                    ";" !== V.charAt(V.length - 1) && (V += ";"), l.setAttribute("style", V + " " + v)
                }
                var q, R = Date.now(), I = P + " " + M, U = (D + O) * L, F = (b + U) * z;
            ...
            var V, q = "Duration", R = "Property", I = "Delay", U = "IterationCount", F = "PlayState", H = "$$ngAnimateKey", _ = "$$ngAnimateCSS3Data", B = 3, L = 1.5, z = 1e3, G = {}, W = 0, Y = [], J = null, K = 0, Z = [];
            return {
                animate: function (t, e, n, r, i, o) {
                    ...
                    i = i || {};
                    var o = O(n, "-remove") + " " + O(e, "-add"), a = E("setClass", t, o, i.from);
...
}(window, window.angular), "undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), function (t, e, n) {
    "use strict";
    function r(t, e) {
    ...
    function p(t, e) {
        var r = 1, o = 2, u = {}, c = [], l = u, h = I(t.when(u), {$$promises: u, $$values: u});
        this.study = function (u) {
            ...
            var $ = a(u || {}), v = [], m = [], g = {};
            return R(u, d), u = m = g = null, function (r, o, a) {
                function s() {
                ...
                var d = t.defer(), m = d.promise, g = m.$$promises = {}, y = I({}, r), w = 1 + v.length / 3, b = !1;
    ...
    function v(t, e, i) {
        ...
        function s(n, i) {
            var o, a, s, u, c;
            return o = n[2] || n[3], c = e.params[o], s = t.substring(h, n.index), a = i ? n[4] : n[4] || ("*" == n[1] ? ".*" : null), u = F.type(a || "string") || r(F.type("string"), {pattern: new RegExp(a)}), {
                id: o,
                regexp: a,
                segment: s,
                type: u,
        ...
        e = I({params: {}}, V(e) ? e : {});
        var u, c = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, l = /([:]?)([\w\[\]-]+)|\{([\w\[\]-]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, f = "^", h = 0, d = this.segments = [], p = i ? i.params : {}, $ = this.params = i ? i.params.$$new() : new F.ParamSet, v = [];
        this.source = t;
        for (var m, g, y; (u = c.exec(t)) && (m = s(u, !1), !(m.segment.indexOf("?") >= 0));)g = o(m.id, m.type, m.cfg, "path"), f += a(m.segment, g.type.pattern.source, g.squash), d.push(m.segment), h = c.lastIndex;
        y = t.substring(h);
        var w = y.indexOf("?");
        if (w >= 0) {
            var b = this.sourceSearch = y.substring(w);
            if (y = y.substring(0, w), this.sourcePath = t.substring(0, h + w), b.length > 0)for (h = 0; u = l.exec(b);)m = s(u, !0), g = o(m.id, m.type, m.cfg, "search"), h = c.lastIndex
    ...
    function g() {
        ...
        function u() {
            return {strict: y, caseInsensitive: $}
        }
        ...
        var p, $ = !1, y = !0, w = !1, b = {}, x = !0, C = [], S = {
            ...
            any: {encode: e.identity, decode: e.identity, is: e.identity, equals: e.equals, pattern: /.*/}
        };
        g.$$getDefaultValue = function (t) {
            ...
            return b[t] = new m(I({name: t}, e)), n && (C.push({name: t, def: n}), x || l()), this
        }, R(S, function (t, e) {
            b[e] = new m(I({name: e}, t))
            ...
            function o(t) {
                var e = V(t) ? a(t) : [], n = -1 === s(e, "value") && -1 === s(e, "type") && -1 === s(e, "squash") && -1 === s(e, "array");
                return n && (t = {value: t}), t.$$fn = c(t.value) ? t.value : function () {
                    return t.value
                }, t
            }
            ...
            function $(t, e, r, i) {
                ...
                return o = q(t.replace) ? t.replace : [], N(i) && o.push({from: i, to: n}), a = d(o, function (t) {
                    return t.from
                }), h(u, function (t) {
                    return -1 === s(a, t.from)
                }).concat(o)
            ...
            var S = r.value !== n, E = f(r, S), k = $(r, C, S, E);
            I(this, {
                id: t,
                type: e,
                location: i,
            ...
            $$new: function () {
                return r(this, I(new f, {$$parent: this}))
            }, $$keys: function () {
    ...
    function y(t, r) {
        ...
        this.rule = function (t) {
            ...
            }, c = {matcher: r.isMatcher(t), regex: t instanceof RegExp};
    ...
    function w(t, i) {
        ...
        function $(e) {
            ...
            return S[n] = e, !e[k] && e.url && t.when(e.url, ["$match", "$stateParams", function (t, n) {
                C.$current.navigable == e && c(t, n) || C.transitionTo(e, t, {inherit: !0, location: !1})
            }]), p(n), e
        }
        ...
        function m(t) {
            var e = t.split("."), n = C.$current.name.split(".");
        ...
        function w(t, i, o, s, h, p, $) {
            ...
            function y(t, n, r, a, u, c) {
                var f = r ? n : l(t.params.$$keys(), n), d = {$stateParams: f};
                ...
                return a && p.push(a), R(t.views, function (n, r) {
                    ...
                    i.$template = [function () {
                        return o.load(r, {view: n, locals: d, params: f, notify: c.notify}) || ""
            ...
            var w = i.reject(new Error("transition superseded")), E = i.reject(new Error("transition prevented")), A = i.reject(new Error("transition aborted")), T = i.reject(new Error("transition failed"));
            return x.locals = {resolve: null, globals: {$stateParams: {}}}, C = {
                params: {},
                current: x.self,
                $current: x,
                transition: null
            }, C.reload = function () {
                return C.transitionTo(C.current, p, {reload: !0, inherit: !1, notify: !0})
            }, C.go = function (t, e, n) {
                return C.transitionTo(t, e, I({inherit: !0, relative: C.$current}, n))
                ...
                var a, c = C.$current, h = C.params, d = c.path, v = f(e, o.relative);
                if (!j(v)) {
                    var m = {to: e, toParams: n, options: o}, S = g(m, c.self, h, o);
                    if (S)return S;
                ...
                var A = e.path, O = 0, D = A[O], M = x.locals, P = [];
                if (!o.reload)for (; D && D === d[O] && D.ownParams.$$equals(n, h);)M = P[O] = D.locals, O++, D = A[O];
                ...
                r = I({lossy: !0, inherit: !0, absolute: !1, relative: C.$current}, r || {});
                var i = f(t, r.relative);
                if (!j(i))return null;
                r.inherit && (e = u(p, e || {}, C.$current, i));
                var o = i && r.lossy ? i.navigable : i;
                return o && o.url !== n && null !== o.url ? $.href(o.url, l(i.params.$$keys(), e || {}), {absolute: r.absolute}) : null
            }, C.get = function (t, e) {
        ...
        var x, C, S = {}, E = {}, k = "abstract", A = {
            parent: function (t) {
                ...
                var e = {};
                return R(j(t.views) ? t.views : {"": t}, function (n, r) {
        ...
        var s = o(), u = s("$animator"), c = s("$animate"), l = {
            ...
            compile: function (n, o, s) {
                return function (n, o, u) {
                    ...
                    function l(a) {
                        var l, f = E(n, u, o, i), g = f && t.$current && t.$current.locals[f];
                        if (a || g !== p) {
                    ...
                    var f, h, d, p, $ = u.onload || "", v = u.autoscroll, m = a(u, n);
        ...
        return {
            restrict: "ECA", priority: -400, compile: function (i) {
                ...
                return function (i, a, s) {
                    var u = n.$current, c = E(i, s, a, r), l = u && u.locals[c];
                    if (l) {
                        a.data("$uiView", {name: c, state: l.$$state}), a.html(l.$template ? l.$template : o);
                        var f = t(a.contents());
                        if (l.$$controller) {
                            l.$scope = i;
    ...
    function T(t, n) {
        ...
        return {
            restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function (i, o, a, s) {
                var u = k(a.uiSref, t.current.name), c = null, l = A(o) || t.$current, f = null, h = "A" === o.prop("tagName"), d = "FORM" === o[0].nodeName, p = d ? "action" : "href", $ = !0, v = {
                    relative: l,
                    inherit: !0
    ...
    function O(t, e, n) {
        return {
            restrict: "A", controller: ["$scope", "$element", "$attrs", function (e, r, i) {
                function o() {
    ...
    var j = e.isDefined, P = e.isFunction, N = e.isString, V = e.isObject, q = e.isArray, R = e.forEach, I = e.extend, U = e.copy;
    ...
    v.prototype.concat = function (t, e) {
        ...
        for (o = 0; u > o; o++) {
            ...
            if (l) {
                var g = n[o + 1];
                if (v === !1)null != m && (c += q(m) ? d(m, e).join("-") : encodeURIComponent(m)), c += g; else if (v === !0) {
                    var y = c.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
                    c += g.match(y)[1]
                } else N(v) && (c += v + g)
            } else {
